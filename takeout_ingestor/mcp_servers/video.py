...
mcp = FastMCP("Pixeltable Video Index")

# Base directory for all indexes - updated for takeout
DIRECTORY = 'takeout_video'

# Registry to hold all video indexes
video_indexes = {}

@mcp.tool()
def setup_video_index(table_name: str, openai_api_key: str) -> str:
    ...
    Args:
        ...
        openai_api_key: The OpenAI API key required for transcription.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run Video MCP server")
    parser.add_argument("--host", default="0.0.0.0", help="Host to bind to")
    parser.add_argument("--port", type=int, default=8081, help="Port to listen on")
    args = parser.parse_args()

    run_mcp_server(mcp._mcp_server, args.host, args.port)
